      ...
      <div className='container'>
        {
         ...
         {/* cart items */}
         {
          ...
          <div className='remove-button d-flex justify-content-center align-items-center' style={{color: "red", cursor: "pointer"}} onClick={() => removeFromCartHandler(cartItem?.productId)}>
